...
_MODEL_INFO: Dict[str, Dict[str, str]] = {
    "mobilenet_v2": {
        ...
        "params": "~3.5M",
        "imagenet_top1": "~71.8%",
        "notes": "Nhẹ, nhanh; phù hợp thiết bị yếu hoặc cần tốc độ cao.",
    },
    "efficientnet_v2_b0": {
        ...
        "params": "~7.1M",
        "imagenet_top1": "~78.7%",
        "notes": "Cân bằng tốt giữa tốc độ và độ chính xác.",
    },
    "efficientnet_v2_b3": {
        ...
        "params": "~14.4M",
        "imagenet_top1": "~82–83%",
        "notes": "Độ chính xác cao hơn; tốn tài nguyên hơn B0/MobileNetV2.",
    },
}
